...
const CAMPAIGN_STAGES = [
  {
    ...
    lore_pre_en: 'To enter the Forge tournament, every commander must prove their worth at the Gates of the Bastion. Two veteran guards block your passage. They laughed when you announced your name. They won\'t be laughing for long.',
    ...
    lore_post_en: 'The gates open. The guards, still stunned, nod in silence. Inside the Bastion, the name of a new commander begins to circulate through the corridors.',
  ...
  },
  {
    ...
    lore_pre_en: 'The path to the arena passes through the Grey Forest. They say mercenaries hired by rivals eliminate promising competitors here. You felt eyes in the dark before you saw them.',
    ...
    lore_post_en: 'The mercenaries flee into the trees. Who hired them remains a mystery — but the message is clear: you\'re already enough of a threat to be hunted.',
  ...
  },
  {
    ...
    lore_pre_en: 'At the heart of central territory stands the Temple of the Guardians — an ancient order that judges the worthiness of those who aspire to power. They do not attack out of malice. They attack out of duty.',
    ...
    lore_post_en: 'The senior Guardian bows their head. "You passed the test of endurance," they say. "But true power lies beyond this temple." A golden insignia is placed in your hand.',
  ...
  },
  {
    ...
    lore_pre_en: 'The Crystal Tower floats above the lake to the east — home of the Council Mages. They rarely descend to fight. Today they descended.',
    ...
    lore_post_en: '"Impressive," the Archmage murmurs, robes singed. "We haven\'t seen a commander like you in decades. The Council will want to meet you... or silence you."',
